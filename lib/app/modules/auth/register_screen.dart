          ...
          child: Stack(
            children: [
              Positioned(
                top: -70,
                right: -30,
                child: _GlowOrb(color: Colors.white.withValues(alpha: isDark ? 0.10 : 0.16), size: 170),
              ),
              Positioned(
                bottom: -80,
                left: -40,
                child: _GlowOrb(color: Colors.black.withValues(alpha: isDark ? 0.16 : 0.08), size: 190),
              ),
              LayoutBuilder(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          spacing: 8,
          runSpacing: 8,
          children: chips.map((chip) => _AuthChip(label: chip)).toList(),
        ),
      ],
    );
  }
...
class _AuthChip extends StatelessWidget {
  ...
  const _AuthChip({required this.label});
