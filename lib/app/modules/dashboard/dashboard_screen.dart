  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        _ActionIconButton(icon: Icons.notifications_none_rounded, onTap: () {}),
  ...
  Widget build(BuildContext context) {
    final actions = <_QuickActionItem>[
      _QuickActionItem(
        ...
        gradient: const [Color(0xFF6D5DF6), Color(0xFF4F46E5)],
        onTap: onTickets,
      ),
      _QuickActionItem(
        title: 'Buat tiket',
        ...
        gradient: const [Color(0xFF06B6D4), Color(0xFF2563EB)],
